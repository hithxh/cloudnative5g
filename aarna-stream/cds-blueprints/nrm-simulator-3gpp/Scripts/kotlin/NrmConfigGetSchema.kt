...
open class NrmConfigGetSchema : AbstractScriptComponentFunction() {

	private val log = LoggerFactory.getLogger(NrmConfigGetSchema::class.java)!!
	...
	override suspend fun processNB(executionRequest: ExecutionServiceInput) {
		...
		log.info("Nrm configuration data from DB : \n$rest_api_json_payload\n")

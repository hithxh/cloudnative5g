...
MARIADB_POD_NAME=$(kubectl get pods -n amcop-system | grep 'dev-cds-db-0' | head -n 1 | awk '{print $1}')
...
kubectl exec -n amcop-system ${MARIADB_POD_NAME} -it -- mysql -u root -pZumu5%NoyuJagx sdnctl
